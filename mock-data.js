 ...
 *   준서 — 짧게 끊는다. 요체와 음슴체를 섞는다.
 *   수민 — 요체. 상황을 한 번 더 설명한다.
 *
 * **다체(~다)로 끝내지 않는다.** 실제 후기는 요체나 음슴체가 대부분이고,
 * 다체로 쓰면 후기가 아니라 일기나 서평처럼 읽힌다. 서비스 컨셉이 '항해일지'라
 * 문어체가 어울릴 것 같지만, 카드에 붙는 건 사용자가 쓴 후기이지 서비스의 문장이 아니다.
 *
 * 다섯 편의 종결어미가 겹치지 않게 둔다. 같은 어미가 반복되면 길이를 바꿔도
 * 한 사람이 지어낸 티가 난다.
...
const mockLogs = [
  {
    id: 'l-1',
    userId: 'u-ilsan',
    quote: '맑은 국물이라 심심할 줄 알았는데 끝맛이 묵직해요. 다음 주에 또 갔어요.',
    restaurantName: '밀밭걸음',
    neighborhood: '정발산',
    date: '2026-08-12',
    willRevisit: 'yes',
  ...
  },
  {
    id: 'l-3',
    userId: 'u-ilsan',
    quote: '반찬 일곱 가지 나오는데 하나도 안 남겼더니 콩자반 더 주심.',
    restaurantName: '등대상회',
    neighborhood: '마두',
    date: '2026-08-09',
    willRevisit: 'yes',
  ...
  },
  {
    id: 'l-5',
    userId: 'u-ilsan',
    quote: '카레는 솔직히 무난해요. 근데 혼자 앉기 좋은 창가 자리가 있어서 또 가게 돼요.',
